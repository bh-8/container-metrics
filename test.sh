...
final_test() {
    ...
    # automatic stego generators: mp3stego, tamp3r
    ...
    # svg
    #tar -xzf "io/test/mp3stego-stego.tar.gz" -C "io/test/."
    #./container-metrics $MONGODB_CONNECTION $DB_ID "mp3-stego-mp3stego" scan io/test/_mp3stego-36-8-20 --recursive $LOGGING
    #./container-metrics $MONGODB_CONNECTION $DB_ID "mp3-stego-mp3stego" scan io/test/_mp3stego-396-24-30 --recursive $LOGGING

    #./container-metrics $MONGODB_CONNECTION $DB_ID "mp3-stego-mp3stego" svg plot "mpeg frames" "part2_3_length" \
    ...
    #./container-metrics $MONGODB_CONNECTION $DB_ID "mp3-stego-mp3stego" svg plot "mpeg frames" "part2_3_length 1st derivative" \
    ...
    #./container-metrics $MONGODB_CONNECTION $DB_ID "pdf-cover5" scan io/test/default-stego/cat-pdf --recursive $LOGGING
